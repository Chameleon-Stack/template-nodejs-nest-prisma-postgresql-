...
-- AddForeignKey
ALTER TABLE "CardCategory" ADD CONSTRAINT "FK_e675a079ca975585da4dc22f5b9" FOREIGN KEY ("category_id") REFERENCES "Category"("id") ON DELETE SET NULL ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "Category" ADD CONSTRAINT "FK_b0599b55851d01efb86c7955cf2" FOREIGN KEY ("user_id") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE NO ACTION;
